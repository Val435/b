...
/**
 * Attempts to retrieve a direct image URL for a given place using GPT.
 * Returns the URL only if it is a direct https image link that responds with HTTP 200.
 */
